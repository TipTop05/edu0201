...
<html lang="ru">
  <head>
    ...
    <!-- Наш CSS должен быть ниже Bootstrap CSS -->
  ...
  <body>
          ...
          <div class="row my-3">
            <div class="col-sm-7 text-center">
              <div id="display" class="p-3 text-center">
                ...
                <p><i<i class="fas fa-wallet"></i> Баланс: <span id="displayBalance">0</span> руб.</p>
                <div class="progress" style="background-color:NavajoWhite; border: 1px solid DarkSlateGrey;">
                  <div class="progress-bar bg-warning" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
              <button class="btn btn-lg btn-warning fs-6 my-3" onclick="getChange(money.value)"><i class="fas fa-hand-holding-usd"></i> Выдать сдачу</button>
              <br>
              <img hidden id="cup_coffee" src="img/cup_coffee.png" alt="чашка кофе"  onclick="CupHidden()">  <!-- чашка кофе скрыта на экране  -->
            </div>
            <div class="col-sm-5 text-center">
              <input hidden  id="money" type="text">
              <img id="bill_acc" src="img/bill_acc.png" alt="купюроприёмник">
    ...
    <div class="container mt-5">
      <img src="img/50rub.jpg" data-value ="50" alt="купюра 50 рублей" >
      <img src="img/100rub.jpg"data-value ="100" alt="купюра 100 рублей" >
      <img src="img/500rub.jpg" data-value ="500" alt="купюра 500 рублей" >
    </div>    
    
    
    <!-- Наш JS в отдельном файле -->
